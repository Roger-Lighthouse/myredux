...
import ConnCall from './containers/conn-call-container'
    ...
    <BrowserRouter>
      <div>
        <ul className='header'>
          ...
          <li><NavLink exact to="/smart_search">Smart Search</NavLink></li>
          <li><NavLink to="/clients">Client</NavLink></li>
          <li><NavLink to="/counter">Counter</NavLink></li>
          <li><NavLink to="/stats">Stats</NavLink></li>
          <li><NavLink to="/joblists">Job Lists</NavLink></li>
          <li><NavLink to="/list">List</NavLink></li>
          <li><NavLink to="/conncall">Conn Calls</NavLink></li>
        </ul>
        <div className='content'>
          <Route exact path="/smart_search" component={ SmartSearch } />
          ...
          <Route path="/conncall" component={ ConnCall } />
          <Route exact path="/:id/clientprofile" component={ ClientProfile } />
        </div>
      </div>
    </BrowserRouter>
